...
function GaussElimination() {
  ...
  useEffect(() => {
    axios.get("http://192.168.99.100:8080/api/users/showgausse").then(res => {
  ...
  return (
    <Content style={{ margin: '0 16px' }}>
      <div style={{ padding: 24, background : '#F8CEA5', minHeight: 30 }}><h1>Gauss Elimination Method</h1></div>
      <Row>
        <Col span={8}>
      ...
      <Row>
        <Col span={8}>
          <div>
            <Button onClick={codeGaussE} type="primary">Enter</Button>
          </div>
        </Col>
        <Col span={8}>
